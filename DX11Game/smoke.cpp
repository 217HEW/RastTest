...
#define	SMOKE_SIZE_X		(200.0f)							// ビルボードの幅
#define	SMOKE_SIZE_Y		(200.0f)							// ビルボードの高さ

#define	MAX_SMOKE			(1024)							// ビルボード最大数
...
HRESULT InitSmoke(void)
{
	...
	{
		pSmoke->pos = XMFLOAT3(0.0f, 0.5f, 0.0f);
		pSmoke->col = XMFLOAT4(1.0f, 0.5f, 0.0f, 1.0f);
